...
@interface IFTweetLabel : UIView 
{
	...
	NSMutableDictionary *linkMap;
	NSMutableArray *linkHref;
...
@property (assign) NSMutableDictionary *linkMap;
@property (assign) NSMutableArray *linkHref;
@property (copy) NSString *sourceText;
@property (assign) NSInteger linkCount;
