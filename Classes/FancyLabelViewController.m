...
- (void)loadView {
	...
	[self.tweetLabel setText:@"<a href=\"http://6.us\">我的博客</a>! This is a #test of regular #expressions with <a href=\"http://example.com\">http://example.com</a> links as used in <a href=\"http://nowa.welost.us\">我的博客</a> @Twitterrific. HTTP://CHOCKLOCK.COM APPROVED OF COURSE."];
